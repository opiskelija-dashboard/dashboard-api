...
class MockPointsStore
  ...
  def self.update_course_points(course_id, jwt_token)
    ...
    if jwt_token.valid?
      ...
      success = false
      errors.push('title' => "Unable to fetch/update points of course #{course_id}",
  ...
  def self.generate_fake_points(course_id)
    ...
    guaranteed_fake_point = fake_point(997, '01_20', 998, course_id, 999, 2, DateTime.new(2007, 0o1, 0o1, 12, 0o0, 0o0, '+3'))
