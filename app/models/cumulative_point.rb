class CumulativePoint
  ...
  def day_point_objects
    ...
    cumulative_all_points_by_day.each do |day, average|
      ...
      points_increment = 0
      unless points_by_day[point_keys[i]].nil?
        points_increment = points_by_day[point_keys[i]]
      end
  ...
  def cumulativize_points(points_by_day)
    return {} if points_by_day.nil? || points_by_day.empty?

    days = points_by_day.keys
    days.sort!
    cumulative_points_by_day = {}
